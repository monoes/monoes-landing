...
export function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      disabled={pending}
      aria-busy={pending}
      className="flex w-full items-center justify-center gap-2 rounded-md border border-espresso/30 bg-ivory px-5 py-2 text-sm font-medium text-espresso transition-colors hover:bg-ivory-parchment disabled:opacity-50"
    >
