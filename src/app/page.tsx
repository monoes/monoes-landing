  ...
  useEffect(() => {
    ...
    (function () {
      ...
      var ACHIEVEMENTS: Record<string, {title:string;desc:string;icon:string}> = {
        ...
        'slide-platform': { title: 'PLATFORM UNLOCKED',  desc: '230+ agents deployed',           icon: '🛡' },
      ...
      (function initTerminal() {
        ...
        var lines = [
          ...
          { type:'gold',    text:'→ Memory: 847 facts indexed to HNSW store' },
          ...
          { type:'dim',     text:'' },
          { type:'out',     text:'✓ All systems nominal · 230+ agents · 24/7 · uptime 99.97%' },
        ];
            ...
            <div className="hero-cols">
              <div className="slide-in">
                <div className="hero-kicker">
                  ...
                  Open source · MIT License · v1.13.0
                </div>
          ...
          <div className="slide-content">
            ...
            <div className="capabilities-grid slide-in">
              <div className="cap-card game-frame">
                ...
                <div className="cap-title">230+ specialized agents</div>
                <p className="cap-body">Domain experts across engineering, security, architecture, marketing, sales, finance, legal, and operations. Hierarchical swarms fan out in parallel, not sequential pipelines that bottleneck.</p>
              ...
              <div className="cap-card game-frame">
                ...
                <div className="cap-title">Four-tier memory palace</div>
                <p className="cap-body">BM25 + HNSW vector search. 150× faster retrieval than RAG alone. Every decision, pattern, and correction stored and retrieved. The system gets smarter with every task it runs.</p>
                <div className="cap-code">/mastermind:memory search &quot;auth patterns&quot;<br /><span style={{color:'rgba(200,220,200,0.7)'}}>↳ 12 results · HNSW hit · top score 0.97 · 3ms</span></div>
              </div>
              <div className="cap-card game-frame">
                <span className="cap-num">03 · Automation</span>
                <div className="cap-title">22 hooks · 10 workers</div>
                <p className="cap-body">Self-learning hook system that fires on every edit, commit, task, and deployment. Background workers handle security scanning, performance monitoring, and git hygiene continuously.</p>
        ...
        <section className="slide slide-light" id="slide-company" style={{background:'var(--ivory)'}}>
          <div className="slide-content">
            ...
            <div className="org-summary slide-in">
              <div className="org-stat"><span className="org-stat-num" data-count="230">230+</span><span className="org-stat-label">Agent types</span></div>
          ...
          <div className="slide-content" style={{maxWidth:'760px'}}>
            ...
            <div className="oss-row slide-in">
              ...
              <div className="oss-pills">
                ...
                <span className="oss-pill">v1.13.0</span>
              </div>
            </div>
          </div>
        </section>
